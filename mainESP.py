...
#         self.send_uart_data([5])
    ...
    def initialize_ui(self):
        ...
        #self.addTouchItem(self.TouchArea(d_x, d_y, draw_area, draw_area), self.save_mnist)
...
#         mnist_data = self.vectorize_and_scale(self.buffer)
#         vlsb_data = self.mnist_to_ssd1306_vlsb(bytearray(mnist_data))
        
        #print(self.buffr)
        #image_sc = self.vector_scale_to_bytearray()#min_x - 5, min_y - 5, width + 10, height + 10)
